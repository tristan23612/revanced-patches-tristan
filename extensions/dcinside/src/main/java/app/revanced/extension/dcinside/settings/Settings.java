...
public class Settings extends BaseSettings {
    ...
    public static final BooleanSetting ENABLE_USER_ID_GALL_SCOPE = new BooleanSetting("revanced_enable_user_id_gall_scope", TRUE, Setting.parent(SHOW_USER_ID));
    ...
    public static final BooleanSetting ENABLE_DC_BAN_LIST_IDENTIFIER_SEARCH = new BooleanSetting("revanced_enable_dc_ban_list_identifier_search_button", TRUE);
    public static final BooleanSetting ENABLE_DC_BAN_LIST_BAN_LIST_EXPORT = new BooleanSetting("revanced_enable_dc_ban_list_ban_list_export_button", TRUE);
